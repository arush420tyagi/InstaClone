...
const PostForm = () => {
  ...
  function postToServer(e) {
    ...
    fetch("https://instaclone.herokuapp.com/posts", {
      method: "POST",
      body: formData,
    })
      .then((response) => {
  ...
  return (
    <div>
      <Navbar />
      {<div style={{visibility:uploading?"visible":"hidden"}} className="uploader-message">{uploading &&<h4 className="uploading-text">Uploading.................</h4>}</div>}
